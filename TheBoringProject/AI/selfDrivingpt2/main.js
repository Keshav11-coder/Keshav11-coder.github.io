...
const traffic=[
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"KEYS",2),
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"DUMMY",2),
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"DUMMY",2),
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"DUMMY",2),
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"DUMMY",2),
    new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99, -100),30,50,"DUMMY",2),
...
function respawnTraffic(){
    if(traffic.length <50){
        let y = ycount - 100;
        traffic.push(new Car(road.getLaneCenter(randomize(0, 2)),randomize(-99999, y),30,50,"DUMMY",2))
    }
}
